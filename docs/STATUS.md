...
- Long sentences split at conservative normalized-text bounds. Broader per-engine token/phoneme-limit stress tests remain necessary. A failed sentence can be skipped via a later word/page selection; equations are never interpreted.
